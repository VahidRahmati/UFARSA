% The script "demo_UFASAR_simData.m" simulates a Poisson spike train and the corresponding fluorescence trace (i.e.  
% time-course). Simply run this script and see UFASAR's spiking activity reconstruction results for this trace. You can  
% change the simulation parameters below in block 1. To apply UFASAR to your recorded data please see "demo_UFASAR_realData.m"
% file. Below, in blocks 2 and 3, you can set the central parameter of UFASAR and decide on the main steps of UFASAR. 
...
nFrames       = 3000; % number of simulated frames
...
[fluor, true_spikes] = sim_fluor_UFASAR(firing_rate, fs, tau, std_noise_sim, nFrames, seed);
...
%% 4: run UFASAR
[output_UFASAR,opt_out] = run_UFASAR(opt,fluor,true_spikes);
