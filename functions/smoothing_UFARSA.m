function [fluor_smoothed, Noise_trace, smoothing_param] = smoothing_UFARSA(opt,fluor_preSmoothing)

% [fluor_smoothed, Noise_trace, smoothing_param] = smoothing_UFARSA(opt,fluor_preSmoothing)
%
