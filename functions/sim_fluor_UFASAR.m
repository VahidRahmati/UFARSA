function [fluor, spikes] = sim_fluor_UFASAR(firing_rate,frame_rate,tau, std_noise_sim, nFrames, seed)

% [fluor, spikes] = sim_fluor_UFASAR(firing_rate,frame_rate,tau, std_noise_sim, nFrames, seed)
%
