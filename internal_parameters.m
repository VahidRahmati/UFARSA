...
% of UFASAR. After changing the value of any parameter or option, just SAVE 
% the script (CTRL+S), and run again the main code (e.g. demo_UFASAR_realData.m).
% The default parameter values used in this script are according to the paper in which
% we have presented the UFASAR. Please read the "user_guide.pdf" file for more details.
%
...
opt.save_ROIs_all       = 0;       % 1 --> save the cell variable containing the UFASAR's outputs for all fluorescence traces (ROIs), 0: don't save it
